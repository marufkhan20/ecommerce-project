...
const ProductItem: FC<IProps> = ({ product }) => {
  const { thumbnail, colors, sizes, title, category, price, rating, reviews } =
    product;
  return (
    <div>
      <div className="bg-[#F8FAFC] rounded-3xl flex items-center justify-center  relative overflow-hidden product-image">
        <img
        ...
        {sizes ? (
          ...
          <div className="absolute transition-all -bottom-[200%] product-option left-0 right-0 w-full flex items-center justify-center gap-2">
            ...
            <button className="text-xs text-primary bg-white px-4 py-2 rounded-full flex items-center gap-1 cursor-pointer shadow-sm">
              <LuExpand />
